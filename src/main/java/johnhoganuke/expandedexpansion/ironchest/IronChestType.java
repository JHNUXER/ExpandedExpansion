 ...
 ******************************************************************************/
 ...
 /******************************************************************************
  * Modified by John R. Chiapetto
  * I, John R. Chiapetto, take no credit for the work of cpw
  *****************************************************************************/
...
public enum IronChestType implements IStringSerializable
{
    ...
    LIGHT_XYCRONIUM(108, 12, false, "Light Xycronium Chest", "lightxycroniumchest.png", 8, Arrays.asList("xWorldIngot"), TileEntityLightXycroniumChest.class, "mmmm2mmmm")
    int size;
        ...
        for (String recipe : type.recipes)
        {
            ...
            for (String mat : type.matList)
            {
                ...
                addRecipe(new ItemStack(blockResult, 1, type.ordinal()), recipeSplit,
                        ...
                        '8', new ItemStack(blockResult, 1, 8)  /* Light Xycronium Chest */
                );
            }
        }
    }
    ...
    {
        return this == OBSIDIAN || this == LIGHT_XYCRONIUM;
    }
