...
public class BlockXOre extends BlockXOreBase {
	...
	public void registerBlockIcons(IIconRegister register)
	{
		...
		if(this == XWorldBlocks.xycroniumOreYellow)
		  icon[1] = register.registerIcon(ProjectX.INSTANCE + ":" + "ore/oreYellow");
	...
	public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune) {
		...
		if(this == XWorldBlocks.xycroniumOreYellow)
		  ret.add(new ItemStack(XWorldItems.gem, 3+fortune, OreType.oreYellow.ordinal()));
		if(this == XWorldBlocks.xycroniumOreRed)
